...
@section('content')
<h3 class="mb-3">Добавить промоутера</h3>
...
<form method="POST" action="{{ route('promoters.store') }}" class="card">
    @csrf
    ...
    <div class="card-body">
        <div class="row g-3">
            <div class="col-md-6">
                ...
                <input class="form-control" name="promoter_full_name" required value="{{ old('promoter_full_name') }}">
            </div>
            ...
            <div class="col-md-4">
                ...
                <select class="form-select" name="promoter_status" required>
                    @php $v = old('promoter_status', 'active'); @endphp
            ...
            <div class="col-md-4">
                ...
                <input class="form-control" type="date" name="fired_at" value="{{ old('fired_at') }}">
            </div>

            <div class="col-md-12">
                <label class="form-label">Комментарий</label>
                <input class="form-control" name="promoter_comment" value="{{ old('promoter_comment') }}">
            </div>
        </div>
    </div>
